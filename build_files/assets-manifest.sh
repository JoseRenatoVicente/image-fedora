...
# ── Asset definitions ────────────────────────────────────────────────────────
# Formato: name|url|sha256|arch_filter|post_install
# arch_filter: vazio = todas as arquiteturas; "x86_64" = só essa
# post_install: comandos shell ($ARCHIVE = ficheiro descarregado, $TMPDIR_ASSETS = dir temp)
# Funções auxiliares definidas em install-assets.sh estão disponíveis no eval.
...
ASSETS=(
  ...
  "catppuccin-aurorae|https://github.com/catppuccin/kde/releases/download/v0.2.6/Classic-Aurorae-Theme.tar.gz|5622fa6cadc8f82890c1e51d6a8c0aee0224984f05809208c7084680a6a22b08||mkdir -p /usr/share/aurorae/themes && tar -xzf \"\$ARCHIVE\" -C /usr/share/aurorae/themes/"

  "catppuccin-sddm|https://github.com/catppuccin/sddm/releases/download/v1.1.2/catppuccin-mocha-mauve-sddm.zip|3d9bcc540924e06ae1aaef6994130170db7f630d7d1b25fe5e780d08493ed67f||mkdir -p /usr/share/sddm/themes && unzip -qo \"\$ARCHIVE\" -d /usr/share/sddm/themes/"
